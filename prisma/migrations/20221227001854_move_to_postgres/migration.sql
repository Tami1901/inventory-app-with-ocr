...
-- CreateIndex
CREATE UNIQUE INDEX "Product_name_code_key" ON "Product"("name", "code");
...
-- AddForeignKey
ALTER TABLE "InventoryEntry" ADD CONSTRAINT "InventoryEntry_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE SET NULL ON UPDATE CASCADE;
